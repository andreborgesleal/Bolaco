    ...
    public class AccountModel : ProcessContext<Cliente, RegisterViewModel, ApplicationContext>
    {
        ...
        public override Validate AfterInsert(RegisterViewModel value)
        {
            ...
            if (db.Parametros.Find((int)DWM.Models.Enumeracoes.Enumeradores.Param.HABILITA_EMAIL).valor == "S")
            {
                ...
                Html += "</div>" +
                        "<div style=\"width: 38%; float: right; margin-top: -185px\"><img src=\"http://bolaco.azurewebsites.net/Content/images/selocircular.png\"></div>" +
                        "</div>";
                ...
                Html += "<p><span style=\"font-family: Verdana; font-size: small; color: #000\">Agora que o seu cadastro foi realizado, já é possível dar os seus palpites no resultado dos jogos do Brasil da primeira fase da copa e de quais seleções disputarão a grande final.</span></p>" +
                        ...
                        "<p><span style=\"font-family: Verdana; font-size: small; padding-left: 15px; color: #000\">- Cadastrar os seus palpites para os jogos do Brasil na primeira fase.</span></p>" +
                        "<p><span style=\"font-family: Verdana; font-size: small; padding-left: 15px; color: #000\">- Cadastrar o seu palpite referente as seleções que farão a grande final da Copa 2014 e o placar do jogo.</span></p>" +
                        "<p><span style=\"font-family: Verdana; font-size: small; padding-left: 15px; color: #000\">- Consultar as estatíticas dos palpites dados por todos os participantes da promoção.</span></p>" +
                        "<p><span style=\"font-family: Verdana; font-size: small; padding-left: 15px; color: #000\">- Consultar todos os seus palpites. Quanto mais você comprar mais palpites poderá fazer.</span></p>" +
                        "<hr />" +
